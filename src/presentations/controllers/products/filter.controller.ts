 ...
 */
export const filterProductController = async (requestData: IRequest) => {
    try {
        // Recupera o usuário pelo ID usando o UserService
        const userFilter = await ProductService.filterProduct([], { page: requestData.pagination.page || 1, pageSize: requestData.pagination.pageSize || 1 });
