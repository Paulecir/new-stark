 ...
 */
export const filterCommissionOrdersPendingController = async (requestData: IRequest) => {
    try {
        // Recupera o usuário pelo ID usando o UserService
        const data = await CommissionService.filterCommissionOrdersPending(requestData.query, [], { page: requestData.pagination.page || 1, pageSize: requestData.pagination.pageSize || 1 });
