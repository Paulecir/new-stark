 ...
 */
export const filterUserSelectController = async (requestData: IRequest) => {
    try {
        // Recupera o usuário pelo ID usando o UserService
        const userFilter = await UserService.filterUserSelect(requestData.query, { page: requestData.pagination.page || 1, pageSize: requestData.pagination.pageSize || 1 });
