 ...
 */
export const filterCategoryController = async (requestData: IRequest) => {
    try {
        // Recupera o usuário pelo ID usando o UserService
        const userFilter = await CategoryService.filterCategory([], { page: requestData.pagination.page || 1, pageSize: requestData.pagination.pageSize || 1 });
